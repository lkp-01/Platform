...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  RegistryQuery: 'bounded resource queries are owned by packages/business/agent-builder/README.md#resource-registry',
  RegistryPage: 'resource summaries are owned by packages/business/agent-builder/README.md#resource-registry',
  AgentVersion: 'immutable snapshots are owned by packages/business/agent-builder/README.md',
  AgentVersionSummary: 'version summaries are owned by packages/business/agent-builder/README.md',
  AgentHistoryPage: 'version history pagination is owned by packages/business/agent-builder/README.md',
  AgentDeployment: 'deployment history is owned by packages/business/agent-builder/README.md',
