...
| --- | --- | --- | --- | --- | --- | --- |
| `ctx.businessAgentPaths` | `core` | [`business-agents`](../packages/bundle/business-agents) | - | - | - | Resolves the optional business bundle preset root relative to its installed package. |
...
| `ctx.agentBuilder` | `core` | [`agent-builder`](../packages/business/agent-builder) | - | - | - | Validates prompt, model and tool selections, publishes immutable Preset directories, and initializes the saved model when a conversation starts. |
