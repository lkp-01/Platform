...
Source: [`packages/business/agent-builder/src/index.ts:52`](../packages/business/agent-builder/src/index.ts)
...
Depends on: [`JsonValue`](../packages/util/values/src/index.ts)
...
- `@deepseek-ai/dsh-business-tools` — requires `sessionProjections` ([`packages/business/business-tools/src/index.ts`](../packages/business/business-tools/src/index.ts))
